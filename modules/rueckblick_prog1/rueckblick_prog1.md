...
| Arrays | Ein- und zweidimensionale Arrays anlegen, füllen und durchlaufen; `Length` und `GetLength(0)`; Arrays an Methoden übergeben | [Eindimensionale Arrays](https://www.erodner.de/prog-lecture/modules/arrays_1d/arrays_1d/), [Mehrdimensionale Arrays](https://www.erodner.de/prog-lecture/modules/arrays_2d/arrays_2d/), [Array-Methoden](https://www.erodner.de/prog-lecture/modules/array_methoden/array_methoden/) |
...
- [.NET Fiddle – C# ohne Installation ausführen](https://dotnetfiddle.net/) – ideal für den Selbsttest: Klasse hineinkopieren, Zeile ändern, sofort sehen, ob sie kompiliert.
